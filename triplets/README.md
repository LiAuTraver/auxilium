> These triplets settings was forked from [Neumann-A/my-vcpkg-triplets](https://github.com/Neumann-A/my-vcpkg-triplets/actions/workflows/ci.yml) with additional settings and triplets for my own use.
# my-vcpkg-triplet
